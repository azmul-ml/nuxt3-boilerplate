        ...
        >
          ...
          <div class="px-1 py-1">
            <MenuItem v-slot="{ active }">
              ...
              >
                <ArchiveBoxIcon :active="active" class="mr-2 h-5 w-5 text-violet-400" aria-hidden="true" />
                Archive
              </button>
            </MenuItem>
            <MenuItem v-slot="{ active }">
              ...
              >
                <DocumentDuplicateIcon :active="active" class="mr-2 h-5 w-5 text-violet-400" aria-hidden="true" />
                Move
              </button>
            </MenuItem>
          </div>
...
import { ChevronDownIcon, ArchiveBoxIcon, DocumentDuplicateIcon, CreditCardIcon } from "@heroicons/vue/20/solid";
